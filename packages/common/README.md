...
[stopwords-json](https://github.com/6/stopwords-json) — Copyright (c) 2017 Peter Graham, contributors. Released under the Apache-2.0 license. With the following sources:
